...
public class UserValidatation implements Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "mobileNumber", "required.phone", "Mobile Number is required.");
		...
		if ( user.getMobileNumber() != null && !user.getMobileNumber().isEmpty() )
		{
			...
			if (!matcher.matches()) {
				errors.rejectValue("mobileNumber", "mobile.incorrect", "Enter a correct Mobile number");
			}
		}
