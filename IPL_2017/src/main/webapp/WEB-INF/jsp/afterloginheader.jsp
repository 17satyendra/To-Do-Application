...
<body>
	<!-- <table class="table table-responsive" bgcolor="#D2691E" align="right"
		cellpadding="15px" cellspacing="15px">
		...
		<tr>
			...
			<td><a href="newAddPlayer"><input type="button"
					value="AddNewPlayer"></a></td>
			<td><a href="createTeam"><input type="button"
					value="CreateNewTeam"></a></td>
			<td><a href="allplayerList"><input type="button"
					value="Players"></a></td>
	...
	<br /> -->
        ...
        <ul class="dropWiddth dropdown-menu"><li><div>BCCI-IPL 4th Floor, <br>
	 Cricket Centre WankhedeStadium ‘D’ Road,<br>
	 Churchgate Mumbai- 400020 India
	  T +91-22-22800300<br>
	  T +91 22 61580300<br>
	  F +91 22 22800354</div></li></ul>
        </li>
